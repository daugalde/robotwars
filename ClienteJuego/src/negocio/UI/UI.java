...
public class UI extends Thread {
    ...
    public void asigna(Pantalla p)  {
        ...
        getAdmin().llenaVec(p.getJ0(), p.getJ1(), p.getJ2(), p.getJ3(), p.getJ4(), p.getJ5(), p.getJ6(), p.getJ7(), p.getJ8(), p.getJ9(), p.getJ10(),
                p.getJ11(), p.getJ12(), p.getJ13(), p.getJ14(),p.getT1(),p.getT2());    
    }
