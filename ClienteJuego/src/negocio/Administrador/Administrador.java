...
public class Administrador {
    ...
    public void obtenerFlujos() throws IOException {
        ...
        salidaObj = new ObjectOutputStream(c.getCliente().getOutputStream());
        salidaObj.flush();
        entradaObj = new ObjectInputStream(c.getCliente().getInputStream());
    }
    ...
    public ObjectOutputStream getSalidaObj() {
        return salidaObj;
    }

    public void setSalidaObj(ObjectOutputStream salidaObj) {
