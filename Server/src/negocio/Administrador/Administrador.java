...
public class Administrador {
    ...
    public void obtenerFlujos() throws IOException {
        ...
        //salida.flush();
        salida = new DataOutputStream(new BufferedOutputStream(getS().getConexion().getOutputStream()));
        entrada = new DataInputStream(new BufferedInputStream(getS().getConexion().getInputStream()));
    ...
    public void llenaVec(JLabel ob0, JLabel ob1, JLabel ob2, JLabel ob3, JLabel ob4, JLabel ob5, JLabel ob6, JLabel ob7, JLabel ob8, JLabel ob9,
        ...
        getObj()[0].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[1].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[2].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[3].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[4].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[5].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[6].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[7].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[8].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[9].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[10].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[11].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[12].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        getObj()[13].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj1.gif")));
        getObj()[14].setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/obj2.gif")));
        
        getJugador().setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/avion.gif")));
        getJugador2().setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/Images/robot2.gif")));
